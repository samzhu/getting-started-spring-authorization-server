...
@Table(
    ...
    schema = "public",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_oauth2_client_redirect_uri_client_uri", columnNames = { "oauth2_client_id", "redirect_uri" })
    }
)
public class Oauth2ClientRedirectUri implements Serializable, Persistable<String> {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final Oauth2ClientRedirectUri other = (Oauth2ClientRedirectUri) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
