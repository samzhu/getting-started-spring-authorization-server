...
@Table(
    ...
    schema = "public",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_user_group_member_group_user", columnNames = { "user_group_id", "user_id" })
    }
)
public class UserGroupMember implements Serializable, Persistable<String> {
